...
class AdminRequirePassword
{
    ...
    public function __construct(ResponseFactory $responseFactory, UrlGenerator $urlGenerator, $passwordTimeout = null)
    {
        ...
        $this->passwordTimeout = $passwordTimeout ?: config('auth.password_timeout', 10800);
    }
    ...
    {
        $confirmedAt = Date::now()->unix() - $request->session()->get('auth.admin.password_confirmed_at', 0);
