            ...
            <div class="admin-login-panel">
                <div class="admin-login-grid">
                    ...
                    <div class="admin-login-form">
                        <h4 class="admin-login-title">Login as an Admin User</h4>
                        ...
                        <form id="formAuthentication" action="{{ route('admin.login') }}" method="POST">
                            @csrf
                            <label class="admin-form-label" for="login">Email or Username</label>
                            ...
                            <div class="admin-login-links">
                                <p class="mb-1">Need help to sign in?</p>
                                @if (Route::has('admin.password.request'))
                                    <a href="{{ route('admin.password.request') }}">Get help signed in.</a>
                                @endif
                            </div>
                        </form>
                    </div>
